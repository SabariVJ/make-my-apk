  ...
  return (
    <header className="sticky top-0 z-40 bg-[#0B0B0C]/90 backdrop-blur-md border-b border-white/5 px-4 py-3 sm:px-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {/* Brand Logo & Name */}
        <div className="flex items-center gap-3 cursor-pointer" onClick={() => setIsEditProfileOpen(true)}>
          ...
          <div>
            <div className="flex items-center gap-1.5">
              <span className="font-anton tracking-wider text-lg text-[#F4F2ED]">
                SVJ
              </span>
              {user.verifiedIcon && (
          ...
          >
            {user.isFounder ? (
              ...
              <>
                ...
                <span className="hidden sm:inline text-[11px] truncate max-w-[100px]">{user.email}</span>
              </>
            ) : (
              <>
