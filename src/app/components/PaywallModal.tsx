        ...
        >
          ...
          {hasLifetimePlus && (
            <div className="relative z-10 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {benefits.map((b, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className="p-3 rounded-2xl bg-[#17171A] border border-white/5 flex items-start gap-3"
                      >
              ...
              <button
                type="button"
                onClick={onOpenPlan}
                className="w-full rounded-2xl border border-[#C81E3A]/40 bg-[#C81E3A]/15 py-3 font-anton text-sm uppercase tracking-wider text-white transition-colors hover:bg-[#C81E3A]/25"
              >
                Open MY SVJ PLAN
              </button>
            </div>
          ...
          {!hasLifetimePlus && !hasActiveTimedPlus && (
            <div className="relative z-10 space-y-6">
              ...
              {hasExpiredTimedPlus && (
                <div className="p-4 rounded-2xl bg-gold/10 border border-gold/30 text-center space-y-1">
                  <p className="text-xs font-mono font-bold text-gold">
                    Your previous SVJ Plus membership has expired.
                  </p>
                  {formattedExpiry && (
                    <p className="text-[11px] font-mono text-gold/70">
              ...
              <div className="p-1 rounded-2xl bg-[#17171A] border border-white/10 max-w-xs mx-auto grid grid-cols-2 text-xs font-mono">
                <button
                  ...
                  className={`py-2.5 rounded-2xl font-semibold transition-all cursor-pointer ${
                ...
                <button
                  ...
                  className={`relative py-2.5 rounded-2xl font-semibold transition-all cursor-pointer ${
                    billingCycle === "yearly"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                ...
                >
                  <div className="absolute -top-2.5 left-4 px-2 py-0.5 rounded-2xl bg-[#C81E3A] text-[9px] font-anton text-white uppercase tracking-wider">
                    BEST VALUE
                  </div>
                  <div className="text-xs font-mono text-[#8C8C90] font-bold uppercase mb-1">
                    Yearly
                ...
                {isAndroid ? (
                  <div className="p-4 rounded-2xl bg-[#17171A] border border-white/10 text-center space-y-2">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-400 text-xs font-mono font-bold hover:bg-emerald-500/30 transition-colors mt-2"
                    >
