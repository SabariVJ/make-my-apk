...
import { Trophy, Crown, Swords, ArrowUpRight, Flame, Shield, TrendingUp, Zap, Sparkles } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-[#8C8C90] font-inter mt-1">
              Complete daily challenges to earn XP, maintain streaks, and climb past global improvers.
            </p>
          </div>
          ...
          >
            ...
            <div className="mx-auto my-2 relative flex justify-center">
              <AvatarFrame
                src={top3[0].avatar}
                alt={top3[0].username}
                frameId={top3[0].id === user.id ? user.equippedFrame : (top3[0].equippedFrame || 'frame-gold')}
                size="xl"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    <span className="font-anton text-sm text-white uppercase">{entry.username}</span>
